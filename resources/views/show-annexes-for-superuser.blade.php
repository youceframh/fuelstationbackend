...
<body>
    <div class="dashboardmain">
        ...
        <div class="dashboardmaincontent">
            ...
            <form action="/dashboard/companies/{{$comp_id}}/annexes" method="GET" style="width:80%;">
               <div class="one">
...
@if(isset($annexes))
        @foreach($annexes as $annex)
              ...
              <div class="sectthree">
              <a type="button" href="/dashboard/companies/{{$comp_id}}/annexes/{{$annex->idannexes}}" class="btn btn-info">المزيد من المعلومات</a>
              </div>
