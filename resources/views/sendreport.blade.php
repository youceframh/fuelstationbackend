...
@if(isset($failed))
  ...
  {{$failed}}
                    ...
                    @endif
                        ...
                        <div class="form-group row">
                            <label for="reportnbr" class="col-md-4 col-form-label text-md-right">{{ __('رقم التقرير') }}</label>

                            <div class="col-md-6">
                                <input id="reportnbr" type="text" class="form-control @error('reportnbr') is-invalid @enderror" name="reportnbr" required autocomplete="reportnbr">
